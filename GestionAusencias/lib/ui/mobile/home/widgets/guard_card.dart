...
class GuardCard extends StatelessWidget {
  ...
  const GuardCard({super.key, required this.guardia});
  ...
  Widget build(BuildContext context) {
    ...
    final esTomorrow = fecha != null &&
        fecha.difference(DateTime(ahora.year, ahora.month, ahora.day)).inDays == 1;
    ...
    final horaInicio =
        guardia.inicio.length >= 5 ? guardia.inicio.substring(0, 5) : guardia.inicio;
    final horaFin =
    ...
    final accentColor = esHoy ? const Color(0xFFF59E0B) : const Color(0xFF6366F1);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: accentColor.withValues(alpha: esHoy ? 0.5 : 0.2)),
      ),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(16),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildBadgeRow(accentColor, fechaLabel, horaInicio, horaFin),
  ...
  Widget _buildBadgeRow(
      Color accentColor, String fechaLabel, String horaInicio, String horaFin) {
    return Row(
      children: [
        Container(
