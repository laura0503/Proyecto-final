...
class TorreKpiCard extends StatelessWidget {
  final String title;
  final String value;
  final String sub;
  final IconData icon;
...
class TorreCriticalCard extends StatelessWidget {
  final int desiertas;
  const TorreCriticalCard({super.key, required this.desiertas});
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          boxShadow: [
            BoxShadow(color: const Color(0xFFF43F5E).withValues(alpha: 0.3), blurRadius: 20, offset: const Offset(0, 10)),
          ],
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
