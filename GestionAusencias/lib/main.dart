...
import 'package:gestion_ausencias/ui/widgets/shared/responsive_manager.dart';
...
void main() async {
  ...
  final profesorRepository = ProfesorRepositoryImpl(remoteDataSource: profesorDataSource);
  final horarioRepository = HorarioRepositoryImpl(remoteDataSource: horarioDataSource);
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider<LoginProfesorUseCase>(create: (_) => LoginProfesorUseCase(profesorRepository)),
        Provider<RegisterProfesorUseCase>(create: (_) => RegisterProfesorUseCase(profesorRepository)),
        Provider<GetProfesoresUseCase>(create: (_) => GetProfesoresUseCase(profesorRepository)),
        Provider<GetHorariosUseCase>(create: (_) => GetHorariosUseCase(horarioRepository)),
        Provider<UpdateProfesorUseCase>(create: (_) => UpdateProfesorUseCase(profesorRepository)),
        Provider<GetAulasUseCase>(create: (_) => GetAulasUseCase(aulaRepository)),
        Provider<GetHorarioAulaUseCase>(create: (_) => GetHorarioAulaUseCase(horarioAulaRepository)),
        Provider<GetGruposUseCase>(create: (_) => GetGruposUseCase(grupoRepository)),
        Provider<GetAsignaturasUseCase>(create: (_) => GetAsignaturasUseCase(asignaturaRepository)),
        Provider<GetSesionActualUseCase>(create: (_) => GetSesionActualUseCase(profesorRepository)),
        Provider<CerrarSesionUseCase>(create: (_) => CerrarSesionUseCase(profesorRepository)),
        Provider<ActualizarProfesorUseCase>(create: (_) => ActualizarProfesorUseCase(profesorRepository)),
        Provider<ImportarProfesoresUseCase>(create: (_) => ImportarProfesoresUseCase(profesorRepository)),
        Provider<ExportarProfesoresUseCase>(create: (_) => ExportarProfesoresUseCase(profesorRepository)),
        Provider<ImportarHorarioUseCase>(create: (_) => ImportarHorarioUseCase(horarioImporter)),
        Provider<EliminarProfesorUseCase>(create: (_) => EliminarProfesorUseCase(profesorRepository)),
        Provider<GetHorarioAulaDetalladoUseCase>(create: (context) => GetHorarioAulaDetalladoUseCase(context.read<HorarioAulaRepository>())),
        Provider<GetHorarioProfesorDetalladoUseCase>(create: (context) => GetHorarioProfesorDetalladoUseCase(context.read<HorarioAulaRepository>())),
        Provider<GetHorarioGrupoDetalladoUseCase>(create: (context) => GetHorarioGrupoDetalladoUseCase(context.read<HorarioAulaRepository>())),
        Provider<GetProfesoresOcupadosUseCase>(create: (context) => GetProfesoresOcupadosUseCase(context.read<HorarioRepository>())),
        Provider<GetProfesoresConEstadoUseCase>(
          create: (context) => GetProfesoresConEstadoUseCase(
            profesorRepository: context.read<ProfesorRepository>(),
            horarioRepository: context.read<HorarioRepository>(),
          ),
        ),
