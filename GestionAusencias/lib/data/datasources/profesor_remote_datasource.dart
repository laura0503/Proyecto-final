    ...
    try {
      ...
      try {
        ...
        final results = await Future.wait([
          _supabase.from('horario').select('id_profesor, id_horario_tramo, id_aula').eq('dia_semana', day),
        ...
        for (final row in rowsHorario) {
          ...
          final int? idTramo = row['id_horario_tramo'];
        ...
        listaProfesores = listaProfesores.map((p) {
          ...
          if (p.estadoAusente) {
            ...
            // Horario escolar pero sin clase en este tramo
            estado = "Disponible";
            // Si tiene jornada hoy pero no clase ahora, está en su departamento
