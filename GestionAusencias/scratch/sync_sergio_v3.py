...
def clean_csv_content(content):
    # Buscar el inicio por los días, siendo flexibles con el primer campo y acentos
...
def procesar_un_archivo(ruta_archivo):
    ...
    try:
        ...
        # Mapeo de nombres de columnas por si acaso Miércoles viene con encoding roto
        col_map = {}
        for c in df.columns:
            for d in dias:
